...
from pruners.graph_pruner import GraphPruner, GraphEdgePruner, DDispPruner
...
def get_parser():
    ...
    parser.add_argument("--start_global_percent", type=float, default=0.1)
...
def main():
    ...
    while True:
        ...
        pruner = DDispPruner(global_percent=global_percent,layer_keep=0.02, score_file=args.score_path)

...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="SIMI")
    ...
    parser.add_argument("--prune-method", type=str, default=None)
    return parser
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        seg_model = eval('networks_amp.'+args.model+'.Seg_Model')(
        ...
        # if args.prune_type=='simi':
        #     train_pruning = pruners.simi_pruning(seg_model, 0.999)
        ...
        if args.prune_type=='simi':
            # train_pruning = pruners.simi8_pruning(seg_model, 0.999)
             train_pruning = eval('pruners.'+args.prune_method)(seg_model, 0.999)
        model.train()
        ...
        while run:
            ...
            for idx in pbar:
                ...
                if global_iteration >= args.num_steps:
                    run = False
                    if main_flag and args.prune_type=='simi':
                        # train_pruning.update_last(seg_model)

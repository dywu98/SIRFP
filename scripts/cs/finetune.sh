...
ALIGN_CORNER='True'
PRUNE_RATIO=0.6
SNAPSHOT_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_06
RESUME_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/score.pth
...
RESUME=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_07
RESUME_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/score.pth
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/dcfp_finetune_p07
RESUME=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.8
SNAPSHOT_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_08
RESUME_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/dcfp_pretrain_deeplabv3p/score.pth
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/dcfp_finetune_p08
RESUME=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_08/pruned.pth
CHANNEL_CFG=ckpt/CS/dcfp_pretrain_deeplabv3p/dcfp_prune_08/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

...
# ALIGN_CORNER='True'
# PRUNE_RATIO=0.6
# SNAPSHOT_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_06
...
SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.5_finetune_resume1
RESUME=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
######
SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.5_finetune_resume2

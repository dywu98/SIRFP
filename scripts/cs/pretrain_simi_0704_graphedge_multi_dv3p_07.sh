...
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_p07_pretrain
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.35
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3p/simi_prune_07
RESUME_DIR=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3p/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3p/score.pth
...
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_p07_finetune_iter1
RESUME=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3p/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3p/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3p/simi_prune_07
RESUME_DIR=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3p/CS_scenes_${NUM_STEPS}.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3p/score.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3p/simi_prune_07/channel_cfg.pth
...
RESUME=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3p/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3p/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
python -m torch.distributed.launch --nproc_per_node=${GPU_NUM} --master_port=12345 evaluate_withflops_acc.py --dataset ${DATASET} --model ${MODEL_NAME} --backbone ${BACKBONE} --batch-size ${TEST_BS} --whole 'True' --flip 'False' --input-size ${INPUT_SIZE} --align-corner ${ALIGN_CORNER} --ms '1' --num-workers ${NUM_WORKERS} --restore-from ${SNAPSHOT_DIR}_${MODEL_NAME}/${DATASET}_scenes_${NUM_STEPS}.pth --save-predict 'False' --channel-cfg ${CHANNEL_CFG}

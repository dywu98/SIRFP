...
# SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.1re2_pretrain
# MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
# PORT=${PORT:-39888}
# PRUNE_METHOD='simi801_pruning'
...
# ALIGN_CORNER='True'
# PRUNE_RATIO=0.6
# SNAPSHOT_DIR=ckpt/CS/simi8canny0.1re2_pretrain_deeplabv3/simi_prune_06
# RESUME_DIR=ckpt/CS/simi8canny0.1re2_pretrain_deeplabv3/CS_scenes_4000.pth
# SCORE_DIR=ckpt/CS/simi8canny0.1re2_pretrain_deeplabv3/score.pth
...
# SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.1re2_finetune
# RESUME=ckpt/CS/simi8canny0.1re2_pretrain_deeplabv3/simi_prune_06/pruned.pth
# CHANNEL_CFG=ckpt/CS/simi8canny0.1re2_pretrain_deeplabv3/simi_prune_06/channel_cfg.pth
# MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
# PORT=${PORT:-29888}
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 3 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.25_pretrain
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-39888}
PRUNE_METHOD='simi8025_pruning'
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.6
SNAPSHOT_DIR=ckpt/CS/simi8canny0.25_pretrain_deeplabv3/simi_prune_06
RESUME_DIR=ckpt/CS/simi8canny0.25_pretrain_deeplabv3/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/simi8canny0.25_pretrain_deeplabv3/score.pth
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.25_finetune
RESUME=ckpt/CS/simi8canny0.25_pretrain_deeplabv3/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/simi8canny0.25_pretrain_deeplabv3/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

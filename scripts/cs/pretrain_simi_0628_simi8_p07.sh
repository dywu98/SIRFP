...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_07
RESUME_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/score.pth
...
RESUME=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_08
RESUME_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/score.pth
...
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/simi8canny0.5_finetune
RESUME=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_08/pruned.pth
CHANNEL_CFG=ckpt/CS/simi8canny0.5_pretrain_deeplabv3/simi_prune_08/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

...
ALIGN_CORNER='True'
PRUNE_RATIO=0.3
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_0711resume_pretrain_psp/simi_prune_06
RESUME_DIR=ckpt/CS/graph_edge_multi_0711resume_pretrain_psp/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_0711resume_pretrain_psp/score.pth
...
RESUME=ckpt/CS/graph_edge_multi_0711resume_pretrain_psp/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0711resume_pretrain_psp/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.6
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter1_psp/simi_prune_06
RESUME_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter1_psp/CS_scenes_${NUM_STEPS}.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter1_psp/score.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0711resume_pretrain_psp/simi_prune_06/channel_cfg.pth
...
RESUME=ckpt/CS/graph_edge_multi_0711resume_finetune_iter1_psp/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0711resume_finetune_iter1_psp/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_0711resume_finetune_iter2_p09
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.9
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_p09_deeplabv3p/simi_prune_06
RESUME_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_p09_deeplabv3p/CS_scenes_${NUM_STEPS}.pth
# RESUME_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_deeplabv3p/CS_scenes_36000.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_p09_deeplabv3p/score.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_p09_deeplabv3p/channel_cfg.pth
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_0711resume_finetune_iter3_p09_real
RESUME=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_p09_deeplabv3p/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0711resume_finetune_iter2_p09_deeplabv3p/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

...
ALIGN_CORNER='True'
PRUNE_RATIO=0.4
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_p08_pretrain_deeplabv3p/simi_prune_08
RESUME_DIR=ckpt/CS/graph_edge_multi_p08_pretrain_deeplabv3p/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_p08_pretrain_deeplabv3p/score.pth
...
RESUME=ckpt/CS/graph_edge_multi_p08_pretrain_deeplabv3p/simi_prune_08/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p08_pretrain_deeplabv3p/simi_prune_08/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.8
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_p08_finetune_iter1_deeplabv3p/simi_prune_08
RESUME_DIR=ckpt/CS/graph_edge_multi_p08_finetune_iter1_deeplabv3p/CS_scenes_${NUM_STEPS}.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_p08_finetune_iter1_deeplabv3p/score.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p08_pretrain_deeplabv3p/simi_prune_08/channel_cfg.pth

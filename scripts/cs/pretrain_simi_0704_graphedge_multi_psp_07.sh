...
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_0721_p07_pretrain
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.35
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_0721_p07_pretrain_psp/simi_prune_07
RESUME_DIR=ckpt/CS/graph_edge_multi_0721_p07_pretrain_psp/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_0721_p07_pretrain_psp/score.pth
...
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_0721_p07_finetune_iter1
RESUME=ckpt/CS/graph_edge_multi_0721_p07_pretrain_psp/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0721_p07_pretrain_psp/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_0721_p07_finetune_iter1_psp/simi_prune_07
RESUME_DIR=ckpt/CS/graph_edge_multi_0721_p07_finetune_iter1_psp/CS_scenes_${NUM_STEPS}.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_0721_p07_finetune_iter1_psp/score.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0721_p07_pretrain_psp/simi_prune_07/channel_cfg.pth
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_multi_0721_p07_finetune_iter2
RESUME=ckpt/CS/graph_edge_multi_0721_p07_finetune_iter1_psp/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_0721_p07_finetune_iter1_psp/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

...
ALIGN_CORNER='True'
PRUNE_RATIO=0.35
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3/simi_prune_07
RESUME_DIR=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3/score.pth
...
RESUME=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3/simi_prune_07
RESUME_DIR=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3/CS_scenes_${NUM_STEPS}.pth
SCORE_DIR=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3/score.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p07_pretrain_deeplabv3/simi_prune_07/channel_cfg.pth
...
RESUME=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3/simi_prune_07/pruned.pth
CHANNEL_CFG=ckpt/CS/graph_edge_multi_p07_finetune_iter1_deeplabv3/simi_prune_07/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

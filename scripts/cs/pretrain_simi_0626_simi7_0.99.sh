...
SNAPSHOT_DIR=ckpt/${DATASET}/simi70.99_pretrain
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.6
SNAPSHOT_DIR=ckpt/CS/simi70.99_pretrain_deeplabv3/simi_prune_06
RESUME_DIR=ckpt/CS/simi70.99_pretrain_deeplabv3/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/simi70.99_pretrain_deeplabv3/score.pth
...
SNAPSHOT_DIR=ckpt/${DATASET}/simi70.99_finetune
RESUME=ckpt/CS/simi70.99_pretrain_deeplabv3/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/simi70.99_pretrain_deeplabv3/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

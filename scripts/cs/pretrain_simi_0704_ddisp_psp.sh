...
SNAPSHOT_DIR=ckpt/${DATASET}/ddisp_estimate_pretrain
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.3
SNAPSHOT_DIR=ckpt/CS/ddisp_estimate_pretrain_psp/simi_prune_06
RESUME_DIR=ckpt/CS/ddisp_estimate_pretrain_psp/CS_scenes_4000.pth
SCORE_DIR=ckpt/CS/ddisp_estimate_pretrain_psp/score.pth

# python prune_ddisp_estimate.py --dataset ${DATASET} --model ${MODEL_NAME} --model-para ${MODEL_PARA} --backbone ${BACKBONE} --backbone-para ${BACKBONE_PARA} --align-corner ${ALIGN_CORNER} --prune-ratio ${PRUNE_RATIO} --save-path ${SNAPSHOT_DIR} --model-path ${RESUME_DIR} --score-path ${SCORE_DIR} 
...
SNAPSHOT_DIR=ckpt/${DATASET}/ddisp_estimate_finetune_iter1
RESUME=ckpt/CS/ddisp_estimate_pretrain_psp/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/ddisp_estimate_pretrain_psp/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.6
SNAPSHOT_DIR=ckpt/CS/ddisp_estimate_finetune_iter1_psp/simi_prune_06
RESUME_DIR=ckpt/CS/ddisp_estimate_finetune_iter1_psp/CS_scenes_${NUM_STEPS}.pth
SCORE_DIR=ckpt/CS/ddisp_estimate_finetune_iter1_psp/score.pth
CHANNEL_CFG=ckpt/CS/ddisp_estimate_pretrain_psp/simi_prune_06/channel_cfg.pth
...
SAVE_PRED_EVERY=800
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/ddisp_estimate_finetune_iter2
RESUME=ckpt/CS/ddisp_estimate_finetune_iter1_psp/simi_prune_06/pruned.pth
CHANNEL_CFG=ckpt/CS/ddisp_estimate_finetune_iter1_psp/simi_prune_06/channel_cfg.pth
MASTER_ADDR=${MASTER_ADDR:-"127.0.0.1"}
PORT=${PORT:-29888}

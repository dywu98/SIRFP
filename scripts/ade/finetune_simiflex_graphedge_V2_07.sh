...
ALIGN_CORNER='False'
PRUNE_RATIO=0.68
SNAPSHOT_DIR=ckpt/ADE/graph_edge_V2_p07_pretrain_deeplabv3/graph_edge_V2_p07_prune_07
...
SAVE_PRED_EVERY=5000
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edge_V2_p07_finetune
RESUME=ckpt/ADE/graph_edge_V2_p07_pretrain_deeplabv3/graph_edge_V2_p07_prune_07/pruned.pth
CHANNEL_CFG=ckpt/ADE/graph_edge_V2_p07_pretrain_deeplabv3/graph_edge_V2_p07_prune_07/channel_cfg.pth

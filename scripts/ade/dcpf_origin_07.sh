...
SNAPSHOT_DIR=ckpt/${DATASET}/dcfp_p07_pretrain
...
ALIGN_CORNER='False'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/ADE/dcfp_p07_pretrain_deeplabv3/dcfp_p07_prune_06
RESUME_DIR=ckpt/ADE/dcfp_p07_pretrain_deeplabv3/ADE_scenes_16000.pth
SCORE_DIR=ckpt/ADE/dcfp_p07_pretrain_deeplabv3/score.pth
...
SAVE_PRED_EVERY=5000
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/dcfp_p07_finetune
RESUME=ckpt/ADE/dcfp_p07_pretrain_deeplabv3/dcfp_p07_prune_06/pruned.pth
CHANNEL_CFG=ckpt/ADE/dcfp_p07_pretrain_deeplabv3/dcfp_p07_prune_06/channel_cfg.pth

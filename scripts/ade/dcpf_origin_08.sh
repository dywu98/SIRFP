...
ALIGN_CORNER='False'
PRUNE_RATIO=0.8
SNAPSHOT_DIR=ckpt/ADE/dcfp_p08_pretrain_deeplabv3/dcfp_p08_prune_06
...
SAVE_PRED_EVERY=5000
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/dcfp_p08_finetune
RESUME=ckpt/ADE/dcfp_p08_pretrain_deeplabv3/dcfp_p08_prune_06/pruned.pth
CHANNEL_CFG=ckpt/ADE/dcfp_p08_pretrain_deeplabv3/dcfp_p08_prune_06/channel_cfg.pth

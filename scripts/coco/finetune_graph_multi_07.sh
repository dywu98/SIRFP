...
ALIGN_CORNER='True'
PRUNE_RATIO=0.35
SNAPSHOT_DIR=ckpt/COCO/graph_pretrain_deeplabv3/graph_prune_07
...
SAVE_PRED_EVERY=1000
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edgev2_finetune_iter1_p07
RESUME=ckpt/COCO/graph_pretrain_deeplabv3/graph_prune_07/pruned.pth
CHANNEL_CFG=ckpt/COCO/graph_pretrain_deeplabv3/graph_prune_07/channel_cfg.pth
...
ALIGN_CORNER='True'
PRUNE_RATIO=0.7
SNAPSHOT_DIR=ckpt/COCO/graph_edgev2_finetune_iter1_p07_deeplabv3/graph_prune_07
RESUME_DIR=ckpt/COCO/graph_edgev2_finetune_iter1_p07_deeplabv3/COCO_scenes_6000.pth
SCORE_DIR=ckpt/COCO/graph_edgev2_finetune_iter1_p07_deeplabv3/score.pth
...
SAVE_PRED_EVERY=1000
SAVE_STEPS=$(($NUM_STEPS - `expr 7 \* ${SAVE_PRED_EVERY}`))
SNAPSHOT_DIR=ckpt/${DATASET}/graph_edgev2_finetune_iter2_p07
RESUME=ckpt/COCO/graph_edgev2_finetune_iter1_p07_deeplabv3/graph_prune_07/pruned.pth
CHANNEL_CFG=ckpt/COCO/graph_edgev2_finetune_iter1_p07_deeplabv3/graph_prune_07/channel_cfg.pth
